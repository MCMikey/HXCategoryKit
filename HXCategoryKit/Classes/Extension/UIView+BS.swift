...
//    }
    ...
    /// 渐变背景色
    func addBackgroundColor(colors: [UIColor], frame:CGRect? = nil, locations:[NSNumber]? = nil, vertical:Bool = true) {
    ...
    static func scaleAnimateBounces(view: UIView, time: TimeInterval, percent: CGFloat, bounce: CGFloat, closure: @escaping ()->Void) {
    ...
    /// 抛物线移动
    static func throwView(view:UIView, endpoint: CGPoint, closure: @escaping ()->Void) {
    ...
    func rotate3DAnimate(closure: @escaping ()->Void) {
    ...
    func retate3DAnimate()-> CAAnimation {
    ...
    // 透明度
    func addOpacityAnimate(beginTime: CFTimeInterval = 0, duration: CFTimeInterval = 0, fromValue: NSNumber = NSNumber(value: 0), toValue: NSNumber = NSNumber(value: 1)) {
    ...
    // 弹性位移
    @available(iOS 9.0, *)
    func addSpringAnimate(fromValue: NSValue, toValue: NSValue, damping: CGFloat = 10, stiffness: CGFloat = 100, mass: CGFloat = 1, beginTime:CFTimeInterval = 0) {
    ...
    // 位移
    func addPositionAnimate(fromValue: NSValue, toValue: NSValue, beginTime:CFTimeInterval = 0, duration: CFTimeInterval = 0.2) {
    ...
    // MARK: - 圆角
    func mc_addCorner(radius: CGFloat, borderWidth: CGFloat, backgroundColor: UIColor, borderColor: UIColor) {
